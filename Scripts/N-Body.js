...
const bodies = [
  new Body(canvas.width/2, canvas.height/2, 1725, 0, 0, 30, "yellow"),
  new Body(canvas.width/2, canvas.height/2.5, 1, 500, 0, 4 + Math.random() * 8, "red"),
  new Body(canvas.width/2, canvas.height/3, 1, 400, 0, 4 + Math.random() * 8, "blue"),
  new Body(canvas.width/2, canvas.height/5, 1, 350, 0, 4 + Math.random() * 8, "orange"),
  new Body(canvas.width/2, canvas.height/7, 1, 300, 0, 4 + Math.random() * 8, "green"),
];
